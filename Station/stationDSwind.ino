...
String GAS_ID = "AKfycbwRpa7JVOIck8bHXQZ2bSukYDs7zxwmZJ9t_-7SCQOV9GFOgrjZAdvccN_OjGMVj3sJwQ"; // Spreadsheet Script ID
...
void sendData(float tem, int hum, String windDir, float windSpeed) {
  if (WiFi.status() == WL_CONNECTED) { // Ensure WiFi is connected
    ...
    String url = "https://" + String(host) + "/macros/s/" + GAS_ID + "/exec?temperature=" + string_temperature + "&humidity=" + string_humidity + "&wind_direction=" + windDir + "&wind_speed=" + string_windSpeed;
